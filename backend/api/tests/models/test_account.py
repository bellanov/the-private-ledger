...
class TestAccountInstantiation:
    ...
    def test_create_account_with_valid_data(self):
        ...
        account = Account(
            id="PL-f3d9c1a24b7e4c18a9d2f6e1b8c04735",
        ...
        assert account.id == "PL-f3d9c1a24b7e4c18a9d2f6e1b8c04735"
    ...
    def test_create_account_with_zero_values(self):
        ...
        account = Account(
            id="PL-8a12e5d94c3f4a7bb6e1820fd9c4512a",
    ...
    def test_create_account_with_decimal_precision(self):
        ...
        account = Account(
            id="PL-4d7b92c1e8f64ab39c15d702fa6e8b41",
    ...
    def test_create_account_with_camel_case_input(self):
        ...
        account = Account(
            id="PL-b6e41d9a73c24f80a5d9e1c24b7f6038",
        ...
        assert account.id == "PL-b6e41d9a73c24f80a5d9e1c24b7f6038"
...
class TestAccountValidation:
    ...
    def test_account_converts_numeric_strings(self):
        ...
        account = Account(
            id="PL-19c7e4b2d5a64fb8b3e1079ac4d862ef",
...
class TestAccountEquality:
    ...
    def test_account_equality_same_values(self):
        ...
        account1 = Account(
            id="PL-a5f28c71d3e6492eb8c4f16a9d7032bc",
            ledger_id="a5f28c71d3e6492eb8c4f16a9d7032bc",
            account_balance=1000.0,
            current_value=1100.0,
            total_shares=10.0,
    ...
    def test_account_inequality_different_balance(self):
        ...
        account1 = Account(
            id="PL-72d4b8e19ac34f5ba1e96c20d7f4836a",
    ...
    def test_account_inequality_different_id(self):
        ...
        account1 = Account(
            id="PL-c8e15a42b9d74f03ae6c1d84f2759b10",
            ledger_id="c8e15a42b9d74f03ae6c1d84f2759b10",
            account_balance=1000.0,
            current_value=1100.0,
            total_shares=10.0,
        ...
        account2 = Account(
            id="PL-5e2f7c1a9d4b4e6f8a3c1d7e9b2f4a6c",
...
class TestAccountSerialization:
    ...
    def test_account_model_dump(self):
        ...
        account = Account(
            id="PL-91ab4e7d2c6f48b3a5d9e0f1c2b7a8d4",
        ...
        assert data["id"] == "PL-91ab4e7d2c6f48b3a5d9e0f1c2b7a8d4"
