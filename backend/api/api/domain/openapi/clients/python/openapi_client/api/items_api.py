...
class ItemsApi:
    ...
    def create_item(
        ...
        :param item_input: (required)
        :type item_input: ItemInput
    ...
    def delete_item(
        self,
        item_id: Annotated[StrictStr, Field(description="The unique identifier of the item.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param item_id: The unique identifier of the item. (required)
        :type item_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
